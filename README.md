...
- Linux：`$XDG_CONFIG_HOME/lx-music-client-auto-download` 或 `~/.config/lx-music-client-auto-download`
- macOS：`~/Library/Application Support/lx-music-client-auto-download`
- Windows：`%APPDATA%/lx-music-client-auto-download`
